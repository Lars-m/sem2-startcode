...
<t:genericpage>
    ...
    <jsp:body>
        ...
        <c:if test="${pageContext.errorData.statusCode == 401 }">
            <p style="color:darkred;font-size: larger">
                Attempt to access a protected resource without being authenticated. Please login first!
            </p>
        </c:if>
        ...
        <c:if test="${pageContext.errorData.statusCode == 500 }">
            <p style="color:darkred;font-size: larger">
                An unexpected problem occurred, we are very sorry!
            </p>
            <p style="color:darkred;font-size: larger">
                Developers should check the log-files
            </p>
        </c:if>
